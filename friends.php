...
<div class="container">
  <div class="row">
	...
	where friends.friends_ID = '$session_id' and members.member_id = friends.my_id
	OR friends.my_id = '$session_id' and members.member_id = friends.friends_id
	");
	...
	?><div class="row">    
            <div class="col-md-2 text-center">
             ...
             <img  src="<?php echo $friend_image; ?>" style="width:100px;height:100px" class="img-circle"></a>
				...
				<div class="col-md-10">
					<div class="pull-right"><a href="delete_friend.php<?php echo '?id='.$id; ?>" class="btn btn-danger unfrndbtn"><i class="icon-remove"></i>  Unfriend </a></div>
